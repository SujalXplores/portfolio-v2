...
<ProsCard 
  title="Benefits of the EyeDropper API:" 
  pros={[
...
MDN Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/API/EyeDropper_API" target="_blank" rel="noopener noreferrer">EyeDropper API</a>
